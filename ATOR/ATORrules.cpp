...
void ATORrulesClass::fillInATORrulesExternVariables()
{
	...
	ATOR_IMAGE_COMPARISON_SQL_SMALL_HUE_DEV_MAP_COMPARISON = false;
	*/
	ATOR_IMAGE_COMPARISON_SQL_GET_TEST_DATA_FROM_SQL = false;
	ATOR_IMAGE_COMPARISON_SQL_ADD_ALL_MAPS_TO_DATABASE = false;
	#endif
	#ifndef ATOR_USE_DATABASE_DECISIONTREE
	//disable all decision tree operations;
	/*
	...
	ATOR_IMAGE_COMPARISON_DECISION_TREE_SMALL_HUE_DEV_MAP_COMPARISON = false;
	*/
	ATOR_IMAGE_COMPARISON_DECISION_TREE = false;
	#endif		
	...
	ATOR_METHOD_GEOMETRIC_COMPARISON_OPTIMISED_FILE_IO_V2_X_BIN_RANGE = (ATOR_METHOD_GEOMETRIC_COMPARISON_OPTIMISED_FILE_IO_V2_NEAREST_FEATURE_MAX_DISTANCE*2.0);	//(12)
	ATOR_METHOD_GEOMETRIC_COMPARISON_OPTIMISED_FILE_IO_V2_Y_BIN_RANGE = (ATOR_METHOD_GEOMETRIC_COMPARISON_OPTIMISED_FILE_IO_V2_NEAREST_FEATURE_MAX_DISTANCE*2.0);	//(12)

	ATOR_METHOD_GEOMETRIC_COMPARISON_OPTIMISED_FILE_IO_V2_X_BIN_SEPARATION = (ATOR_GEOMETRIC_CHECK_COMPARISON_MAX_ERROR);	//(0.3)
	ATOR_METHOD_GEOMETRIC_COMPARISON_OPTIMISED_FILE_IO_V2_Y_BIN_SEPARATION = (ATOR_GEOMETRIC_CHECK_COMPARISON_MAX_ERROR);	//(0.3)
	...
	//!ATOR_USE_SQL·implementation checks (C++ multidimensional array declaration);
	...
	if((ATOR_METHOD_GEOMETRIC_COMPARISON_OPTIMISED_FILE_IO_V2_NO_X_BINS != ATOR_METHOD_GEOMETRIC_COMPARISON_OPTIMISED_FILE_IO_V2_NO_X_BINS_STATIC) || (ATOR_METHOD_GEOMETRIC_COMPARISON_OPTIMISED_FILE_IO_V2_NO_X_BINS != ATOR_METHOD_GEOMETRIC_COMPARISON_OPTIMISED_FILE_IO_V2_NO_X_BINS_STATIC))
	{
		cerr << "!ATOR_USE_SQL·implementation limitation: ((ATOR_METHOD_GEOMETRIC_COMPARISON_OPTIMISED_FILE_IO_V2_NO_X_BINS != ATOR_METHOD_GEOMETRIC_COMPARISON_OPTIMISED_FILE_IO_V2_NO_X_BINS_STATIC) || (ATOR_METHOD_GEOMETRIC_COMPARISON_OPTIMISED_FILE_IO_V2_NO_X_BINS != ATOR_METHOD_GEOMETRIC_COMPARISON_OPTIMISED_FILE_IO_V2_NO_X_BINS_STATIC))" << endl;
		printATORrulesExternVariables();
		exit(EXIT_ERROR);
	}
	#endif
	#ifdef ATOR_IMAGE_COMPARISON_AVERAGE_RGB_BINNING_BASIC_NO_SQL
	if(ATOR_IMAGE_COMPARISON_AVERAGE_RGB_BINNING_NUM_DISTINCT_VALS_PER_COL != ATOR_IMAGE_COMPARISON_AVERAGE_RGB_BINNING_NUM_DISTINCT_VALS_PER_COL_STATIC)
	{
		cerr << "!ATOR_USE_SQL·implementation limitation: (ATOR_IMAGE_COMPARISON_AVERAGE_RGB_BINNING_NUM_DISTINCT_VALS_PER_COL != ATOR_IMAGE_COMPARISON_AVERAGE_RGB_BINNING_NUM_DISTINCT_VALS_PER_COL_STATIC)" << endl;
		printATORrulesExternVariables();
		exit(EXIT_ERROR);
	}
	#endif
...
void ATORrulesClass::printATORrulesExternVariables()
{
	...
	*/
	...
	cout << "ATOR_IMAGE_COMPARISON_AVERAGE_RGB_BINNING_NUM_DISTINCT_VALS_PER_COL = " << ATOR_IMAGE_COMPARISON_AVERAGE_RGB_BINNING_NUM_DISTINCT_VALS_PER_COL << endl;	//20
