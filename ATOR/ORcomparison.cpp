...
#endif
{
	...
	if(OR_GENERATE_IMAGE_COMPARITOR_RESULTS_HTML)
	{
		...
		{
			ICRheader = ICRheader + "<HTML><HEAD><TITLE>Results </TITLE><style type=\"text/css\">TD { font-size:50%; } </style></HEAD><BODY>Results<p>Project Version: 3h9a 09-December-2015<p>";
		}
		else
		{
