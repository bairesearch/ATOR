...
#endif
{
	...
	if(OR_GENERATE_IMAGE_COMPARITOR_RESULTS_HTML)
	{
		...
		{
			ICRheader = ICRheader + "<HTML><HEAD><TITLE>Results </TITLE><style type=\"text/css\">TD { font-size:50%; } </style></HEAD><BODY>Results<p>Project Version: 3i19a 15-December-2016<p>";
		}
		else
		{
